...
# Enable cuDNN, cuBLAS, and cuBLASLt API logging when FlashInfer logging level >= 8
...
def flashinfer_api_log(func: Callable = None) -> Callable:
    ...
    - **cuDNN/cuBLAS/cuBLASLt Integration**: At level 8, if not already set by the user, the following
